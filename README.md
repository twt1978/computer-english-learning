...
| 分类 | 词条数 | 说明 |
|------|--------|------|
| Terminal Commands | 15 | 终端常用命令 |
| Git Commands | 15 | Git版本控制 |
| Error Messages | 15 | 常见错误信息 |
| Programming Terms | 15 | 编程基础术语 |
| Web Development | 15 | Web开发相关 |
| System Terms | 15 | 操作系统术语 |
| Code Comments | 15 | 代码注释常用语 |
| Daily Dev Phrases | 15 | 日常开发用语 |
| Docker & Kubernetes | 15 | 容器与编排 |
| Database & SQL | 15 | 数据库与SQL |
| Algorithms | 15 | 算法与数据结构 |
| Networking | 15 | 网络与协议 |
| Code Review | 15 | 代码审查用语 |
| AI & ML | 15 | 人工智能术语 |
| Agile Development | 15 | 敏捷开发 |
